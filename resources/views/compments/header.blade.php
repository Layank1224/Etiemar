        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="#" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="logo-light" height="65">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-none d-sm-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="{{ asset('assets/images/flags/Flag_of_Saudi_Arabia.png') }}" alt="user-image"
                            class="me-1" height="12"> <span class="align-middle">العربية</span>
                    </a>
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex">
                                ...
                                <div class="flex-1">
                                    <h6 class="mb-1">Here's some notification from the top mangment</h6>
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1">Approved your request!</p>
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1">Rejected your request!</p>
