...
options = {
    ...
    series: [
        { name: "Web devolper", data: [46, 57, 59, 54, 62, 58, 64, 60, 66] },
        { name: "Accountant", data: [74, 83, 102, 97, 86, 106, 93, 114, 94] },
        { name: "IT spicialist", data: [37, 42, 38, 26, 47, 50, 54, 55, 43] },
    ],
...
options = {
    ...
    dataLabels: { enabled: !1 },
    series: [{ data: [150, 200, 250, 370, 410, 450, 500, 540, 580, 600] }],
    colors: ["#1cbb8c"],
    grid: { borderColor: "#f1f1f1", padding: { bottom: 5 } },
    xaxis: {
        categories: [
